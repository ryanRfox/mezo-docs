...
- Validators secure the Mezo chain and earn MEZO rewards via the Chain Splitter in Mezo Earn.
- veBTC holders are the governance anchor. They vote on staking gauges to direct emissions.
...
3. **Validators:** Run Mezo chain nodes, participate in consensus, and receive MEZO emissions via the Chain Splitter.
...
## How Validators Receive Emissions

The chain splitter sends a fixed share of reward emissions to validators, currently set at 20% of reward emissions. This ratio is locked via governance.

Validator emissions are distributed equally among active validators. There is currently no mechanism for veBTC holders to vote on individual validators or direct emissions to specific validators.
...
- The **ecosystem splitter** directs the non-validator pot to staking gauges (LP pools + MUSD savings). This ratio is currently fixed and locked via governance.
- LP gauges then compete with the MUSD savings gauge and other LP gauges for emissions within their branch.
