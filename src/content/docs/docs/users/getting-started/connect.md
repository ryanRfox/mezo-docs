...
For higher rate limits, Boar offers a free API key at [boar.network/mezo](https://boar.network/mezo). Enterprise plan available - contact [hello@boar.network](mailto:hello@boar.network) to get started.
