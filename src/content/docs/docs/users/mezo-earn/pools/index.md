...
Mezo offers three types of pools, optimized for different use cases:
...
* **Concentrated Liquidity (CL) Pools**: Allow you to provide liquidity within a custom price range instead of across the full curve, significantly improving capital efficiency. CL positions are represented as NFTs (ERC-721) rather than fungible LP tokens. See [Concentrated Liquidity](/docs/users/mezo-earn/pools/concentrated-liquidity) for details.
