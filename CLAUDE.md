...
**YOU ARE IN: `mzdc/polecats/jasper/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/mzdc/` (rig root) or other directories
...
**Your mail address:** `mzdc/polecats/jasper`
**Your rig:** mzdc
**Your Witness:** `mzdc/witness`
...
| Ask Witness for help | `gt mail send mzdc/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`mzdc/witness`) when:
...
```bash
gt mail send mzdc/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
